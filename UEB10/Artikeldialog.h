...
#define BIGNUMBER 10000
	...
	public:
		 ...
		 * @param artikelpreis
		 */
		void testeConstructor1(int artikelNr, std::string bezeichnung, double artikelpreis);
		/**
		 ...
		 * @param bestand
		 */
		void testeConstructor2(int artikelNr, std::string bezeichnung, double artikelpreis, int bestand);
		/**
