...
namespace artikel {
	...
	*/
	Artikel::Artikel(int artikelNr, std::string bezeichnung, double artikelPreis, int bestand) throw(ArtikelException){
	...
	*/
	void Artikel::setBezeichnung(std::string neuBezeichnung)  throw(ArtikelException){
	...
	*/
	 ...
	 */
	std::string Artikel::toString() const {
		std::ostringstream o;
	 ...
	 */
	std::ostream& operator<<(std::ostream& o, const Artikel& artikel) {
